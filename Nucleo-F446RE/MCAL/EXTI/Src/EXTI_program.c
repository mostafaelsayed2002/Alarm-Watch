...
{
	EXTI_u8ClearPendingFlag(EXTI0);
    EXTI_Callback[EXTI0]();
}

void EXTI1_IRQHandler(void)
{
	EXTI_u8ClearPendingFlag(EXTI1);
    EXTI_Callback[EXTI1]();
}

void EXTI2_IRQHandler(void)
{
	EXTI_u8ClearPendingFlag(EXTI2);
    EXTI_Callback[EXTI2]();
}

void EXTI3_IRQHandler(void)
{
	EXTI_u8ClearPendingFlag(EXTI3);
    EXTI_Callback[EXTI3]();
}

void EXTI4_IRQHandler(void)
{
	EXTI_u8ClearPendingFlag(EXTI4);
    EXTI_Callback[EXTI4]();
}
...
void EXTI9_5_IRQHandler(void)
{
    if ((EXTI->PR >> EXTI5) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI5);
        EXTI_Callback[EXTI5]();
    }
    if ((EXTI->PR >> EXTI6) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI6);
        EXTI_Callback[EXTI6]();
    }
    if ((EXTI->PR >> EXTI7) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI7);
        EXTI_Callback[EXTI7]();
    }
    if ((EXTI->PR >> EXTI8) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI8);
        EXTI_Callback[EXTI8]();
    }
    if ((EXTI->PR >> EXTI9) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI9);
        EXTI_Callback[EXTI9]();
    }
}
void EXTI15_10_IRQHandler(void)
{
    if ((EXTI->PR >> EXTI10) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI10);
        EXTI_Callback[EXTI10]();
    }
    if ((EXTI->PR >> EXTI11) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI11);
        EXTI_Callback[EXTI11]();
    }
    if ((EXTI->PR >> EXTI12) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI12);
        EXTI_Callback[EXTI12]();
    }
    if ((EXTI->PR >> EXTI13) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI13);
        EXTI_Callback[EXTI13]();
    }
    if ((EXTI->PR >> EXTI14) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI14);
        EXTI_Callback[EXTI14]();
    }
    if ((EXTI->PR >> EXTI14) & 1)
    {
    	EXTI_u8ClearPendingFlag(EXTI15);
