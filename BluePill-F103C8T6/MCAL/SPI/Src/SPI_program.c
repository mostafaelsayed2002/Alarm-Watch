...
static SPI_RegDef_t *SPIx[2] = {SPI1, SPI2};
static uint8_t TXState[2] = {SPI_READY, SPI_READY};
static uint8_t RXState[2] = {SPI_READY, SPI_READY};

static uint8_t *SPIx_TXData[2];
static uint8_t *SPIx_RXData[2];

static uint32_t SPIx_TXLen[2];
static uint32_t SPIx_RXLen[2];

static void (*SPI_TXCallback[2])(void);
static void (*SPI_RXCallback[2])(void);
